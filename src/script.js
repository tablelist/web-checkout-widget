(function(window, document, venueConfigs) {
  ...
  function createIframe(config) {
    ...
    iframeEl.setAttribute('src', '@@DOMAIN/book/' + config.venue + '?client=' + config.venue + '-widget&partner=' + (config.partner || 'venueWidget') + '&theme=' + (config.theme || 'tablelist') + '&widget_id=' + config.id);
